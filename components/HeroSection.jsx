...
import { FaSearch, FaMapMarkerAlt, FaCalendarAlt, FaCar, FaCheckCircle, FaStar } from 'react-icons/fa';
...
export default function HeroSection() {
    ...
    const handleSearch = (e) => {
        ...
        const params = new URLSearchParams({ location, pickup, dropoff, type }).toString();
                ...
                <div className="max-w-2xl">
                    ...
                    <div className="bg-white p-4 rounded-2xl shadow-xl border border-gray-100">
                        <form onSubmit={handleSearch} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4">
                            ...
                            {/* Dropoff Date (Hidden label for visual cleanliness, relying on placeholder/context) */}
                            <div className="lg:col-span-3 relative group">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400 group-focus-within:text-green-600">
                                    <FaCalendarAlt />
                                </div>
