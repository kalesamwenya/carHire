 ...
 */
const CityDriveLoader = ({ message = "Loading Citydrive hire Fleet...", fullScreen = true }) => {
  return (
    <div className={`flex flex-col items-center justify-center bg-white/90 backdrop-blur-sm transition-all duration-500 ${fullScreen ? 'h-screen w-full fixed inset-0 z-[10000]' : 'py-20 w-full'}`}>
