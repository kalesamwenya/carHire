...
export default function PartnerChatPage(props) {
  const user = props.user || { id: 2, name: 'Partner Demo', role: 'partner' };
  const recipient = props.recipient || { id: 1, name: 'Admin Demo', role: 'admin' };
  return (
