        ...
        <div className="space-y-6 max-w-8xl mx-auto pb-10 px-4">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div className="flex items-center gap-4">
                    <Link href="/partner/fleet" className="p-2.5 bg-white border border-gray-200 rounded-xl text-gray-500 hover:text-blue-600 hover:border-blue-200 transition-all shadow-sm">
                        <FaArrowLeft />
                    </Link>
                    <div>
                ...
                <div className="flex gap-2 w-full md:w-auto">
                    <Link href={`/partner/fleet/${id}/edit`} className="flex-1 md:flex-none flex items-center justify-center gap-2 px-4 py-2 bg-white border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 text-sm font-bold shadow-sm">
                        <FaEdit /> Edit
                    </Link>
                    <button 
